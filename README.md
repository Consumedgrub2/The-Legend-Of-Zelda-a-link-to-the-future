...
In the picture below, just click on the link with the little box icon beside it to download the release. Do not worry about the source code, as you do not need it to run the game. If you would like to mod the game, then in the main repository branch, there will be different game versions with the raw data from the game viewable. You can download these and tweak the game files. More about modding [here.](https://github.com/Consumedgrub3/The-Legend-Of-Zelda-a-link-to-the-future/wiki/Modding-the-game)
