...
function item:on_using()
  ...
  item:set_finished()
  print("This thing is a piece of trash. Why would you use it? And also, ocarina of time is way to overrated and was extremely bad. Or at least in my opinion.")
end