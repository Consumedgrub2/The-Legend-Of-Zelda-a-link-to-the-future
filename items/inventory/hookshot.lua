...
local function initialize_meta()
  ...
  -- Make the entities hookable if its type and animation_set is in config.hookable_by_animation_set
  for entity_type, sprite_array in pairs(config.hookable_by_animation_set) do
    local meta = sol.main.get_metatable(entity_type)
    ...
    function meta:is_hookable()
      ...
      for _, sprite_name in ipairs(sprite_array) do
